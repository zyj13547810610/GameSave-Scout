...
<template>
  <form class="batch-save-filters" data-test="batch-filter-form" @submit.prevent="applyFilters">
    ...
    <select v-model="filters.status" data-test="batch-status-filter" aria-label="候选状态">
      ...
      <option value="unknown">未知游戏</option><option value="recorded">已记录</option>
