...
V0.1.x、V0.2.0、V0.2.1、V0.3.2 和 V0.3.3 已完成既定源码与本地候选收口；V0.3.3 是最新本地双版本便携候选。V0.3.1 自定义规则编辑器及真实 pywebview 工作台验收已完成，V0.3.2 第二批引擎与存档规则也已随 V0.3.3 新技术身份进入便携候选，schema 保持 4。2026-08-26 完成顶部四入口与工具工作区界面重构，当前源码门禁为 Python 1278 项通过、1 项跳过，前端 242 项及完整静态、类型、构建和 schema 4 smoke 均通过；缺少样本的真实游戏规则矩阵仍保留为后续工作。完整目标 Windows 10/11 设备、SmartScreen、UNC/只读目录和特殊运行时故障矩阵没有全部执行，作为后续可选兼容性复核。
