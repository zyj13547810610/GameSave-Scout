...
from gamesave_scout.engines.models import DetectionOutcome, EngineEvidence
...
from gamesave_scout.scanning.path_keys import PathTraversalError, expand_relative
