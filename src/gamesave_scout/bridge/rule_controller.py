...
from gamesave_scout.bridge.tasks import TaskContext, TaskRegistry
...
_RULE_FILE_TYPES = ("GameSave Scout 规则 (*.yaml;*.yml)",)
...
class RuleBridgeController:
    ...
    def export_rule(self, request: object) -> ApiResult:
        try:
            ...
            rule_id = qualified_id.partition(":")[2] or "gamesave-scout-rule"
