GameShelf 0.2.1 Windows x64 轻量联网便携版
========================================
...
Evergreen 时，GameShelf 会先校验随包的微软官方安装器，并询问是否打开安装位置。
...
- 微软安装器断网或安装失败时，由安装器自身提示；重新启动后 Runtime 仍缺失时，
  GameShelf 会再次显示手动安装引导，不会记录为程序崩溃。
...
GameShelf 0.2.1 本体未进行 Authenticode 代码签名。随包
